...
- [x] e2e-tests: node-details: Add test for node details page (tested in `nodes.spec.ts`)
...
- [x] e2e-tests: endpointslices-list: Add test for endpoint slices list page (tested in `network.spec.ts`)
...
- [x] e2e-tests: ingress-classes-list: Add test for ingress classes list page (tested in `network.spec.ts`)
...
### Custom Resources
- [x] e2e-tests: crds-list: Add test for CRDs list page (tested in `crds.spec.ts`)
...
- [x] e2e-tests: cr-instances-list: Add test for CR instances list page (tested in `crds.spec.ts`)
