...
> which authenticates with Dex and forwards the user's identity to Headlamp
> as an HTTP header. See the dedicated tutorial:
...
> approach and is kept for reference.
