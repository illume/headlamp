...
> all the steps below is provided in the [`test-scripts/`](https://github.com/kubernetes-sigs/headlamp/tree/main/docs/installation/in-cluster/dex-oauth2-proxy/test-scripts)
...
command, see [`test-scripts/`](https://github.com/kubernetes-sigs/headlamp/tree/main/docs/installation/in-cluster/dex-oauth2-proxy/test-scripts).
