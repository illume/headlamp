...
| `jsonData` | `public` | [`KubeControllerRevision`](../interfaces/KubeControllerRevision.md) | `undefined` | - | - | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`jsonData` | [src/lib/k8s/KubeObject.ts:47](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/KubeObject.ts#L47) |
...
| `apiName` | `static` | `string` | `'controllerrevisions'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiName` | - | [src/lib/k8s/controllerRevision.ts:55](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/controllerRevision.ts#L55) |
| `apiVersion` | `static` | `string` | `'apps/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiVersion` | - | [src/lib/k8s/controllerRevision.ts:56](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/controllerRevision.ts#L56) |
| `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`isNamespaced` | - | [src/lib/k8s/controllerRevision.ts:57](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/controllerRevision.ts#L57) |
...
| `kind` | `static` | `string` | `'ControllerRevision'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`kind` | - | [src/lib/k8s/controllerRevision.ts:54](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/controllerRevision.ts#L54) |
...
[src/lib/k8s/controllerRevision.ts:59](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/controllerRevision.ts#L59)
...
[src/lib/k8s/controllerRevision.ts:63](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/controllerRevision.ts#L63)
...
```ts
patch(body: RecursivePartial<KubeControllerRevision>): Promise<any>
```
...
| Parameter | Type |
| ------ | ------ |
| `body` | [`RecursivePartial`](../../api/v1/factories/type-aliases/RecursivePartial.md)\<[`KubeControllerRevision`](../interfaces/KubeControllerRevision.md)\> |
