...
| `jsonData` | `public` | [`KubeRoleBinding`](../interfaces/KubeRoleBinding.md) | `undefined` | - | - | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`jsonData` | [src/lib/k8s/KubeObject.ts:47](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/KubeObject.ts#L47) |
...
| `apiName` | `static` | `string` | `'rolebindings'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiName` | - | [src/lib/k8s/roleBinding.ts:36](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/roleBinding.ts#L36) |
| `apiVersion` | `static` | `string` | `'rbac.authorization.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiVersion` | - | [src/lib/k8s/roleBinding.ts:37](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/roleBinding.ts#L37) |
| `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`isNamespaced` | - | [src/lib/k8s/roleBinding.ts:38](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/roleBinding.ts#L38) |
...
| `kind` | `static` | `string` | `'RoleBinding'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`kind` | - | [src/lib/k8s/roleBinding.ts:35](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/roleBinding.ts#L35) |
...
[src/lib/k8s/roleBinding.ts:40](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/roleBinding.ts#L40)
...
[src/lib/k8s/roleBinding.ts:44](https://github.com/illume/headlamp/blob/97134a5757d74d8d8866df332283bb67229580c7/frontend/src/lib/k8s/roleBinding.ts#L44)
