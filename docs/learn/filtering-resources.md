...
![Label Selector Input](../images/label-selector-filter.png)
...
- Invalid syntax will be ignored - check the Kubernetes label selector documentation if a filter isn't working as expected
