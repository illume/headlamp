...
describe('MCPToolRouter', () => {
  ...
  describe('computeRelevanceScore', () => {
    ...
    it('returns 0 for no match', () => {
      expect(computeRelevanceScore(['kubernetes', 'pod'], new Set(['javascript', 'react']))).toBe(0);
    });
  ...
  describe('buildToolSearchText', () => {
    it('includes name, server, and description', () => {
      const tool = makeTool('kubectl-server__get_pods', 'List pods in a namespace', 'kubectl-server');
